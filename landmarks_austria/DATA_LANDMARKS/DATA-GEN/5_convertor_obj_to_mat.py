    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".obj"):
            ...
            try:
                ...
                print(f"File: {filename} | Vertices: {len(all_vertices)} | Faces: {len(mesh.faces)} | Colors: {len(all_colors)}")
...
input_folder = "F:/TREES/NEW/DSM_OBJ" # dsms_deciduous" # "F:\TREES\TREES-temp" # "F:/TREES/dsms_deciduous" # dsms_conifers" # conifers" # deciduous/"
output_folder = "F:/TREES/NEW/DSM" # DATASET/DSM" # DSM/"
os.makedirs(output_folder, exist_ok=True)
convert_obj_to_mat_DSM(input_folder, output_folder)

# python 5_convertor_obj_to_mat.py

# scp -P 31415 F:\TREES\DATASET\ORTHOPHOTOS.tar grammatikakis1@dgxa100.icsd.hmu.gr:/home/grammatikakis1/
# tar -xf ORTHOPHOTOS_N.tar -C /home/grammatikakis1/DATASET/ORTHOPHOTOS_N
