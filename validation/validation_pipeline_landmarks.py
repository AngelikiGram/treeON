...
if __name__ == "__main__":
    ...
    parser.add_argument('--dsm_dir', type=str, default='./landmarks_austria/DATA_LANDMARKS/DSM1/')
    ...
    parser.add_argument('--log_dir', type=str, default='log', help='Log directory name (default: log)')
    ...
    with torch.no_grad():
        for ortho_img, dsm_points, index_view, filename, center_dsm, scale_dsm, original_dsm, labels in dataloader:
            ...
            for p in range(B):
                ...
                if args.model == '5' or args.model == '11': # save colors
