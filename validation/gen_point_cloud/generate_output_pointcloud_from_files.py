...
# python validation/gen_point_cloud/generate_output_pointcloud_from_files.py --dsm_mat france_data/DSM_MAT/dsm_3.mat --ortho_img france_data/ORTHOPHOTOS/ortho_3.png --output_root results/landmarks/FRANCE --model_path mixed_all_450 --env test_env