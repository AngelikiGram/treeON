...
BASE = r"C:\Users\mmddd\Documents\treeON\results"
TREE_DIR     = os.path.join(BASE, "TREE_MODELS", MODEL_NAME, "pointclouds-landmarks") 
if dsm:
    TREE_DIR     = r"C:\Users\mmddd\Documents\treeON\landmarks_austria\DATA_LANDMARKS\DSM_OBJ"
...
if supersample: 
    TREE_DIR     = os.path.join("C:/Users/mmddd/Documents/P2/supersample_pointclouds/OUTPUTS_ablation/", MODE_NAME + "-" + MODEL_NAME) # + '1')   
    OUT_DIR      = os.path.join(BASE, "outputs", MODEL_NAME) # , f"supersample-{MODE_NAME}")

RENDER_SIZE  = (512, 512)
DEFAULT_POINT_RADIUS = 0.035 # 01 # fallback value
