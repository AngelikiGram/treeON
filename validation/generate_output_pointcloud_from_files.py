...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_points", type=int, default=4000, help="Number of output points")
...
# python validation/generate_output_pointcloud_from_files.py --dsm_mat france_data/DSM_MAT/dsm_3.mat --ortho_img france_data/ORTHOPHOTOS/ortho_3.png --output_root results/landmarks/FRANCE --model_path mixed_all_450 --env test_env