...
if __name__ == "__main__":
    ...
    save_path = opt.env
    dir_name = os.path.join('./log', save_path) # ./log
    ...
    with open("/home/grammatikakis1/P2/TREES_DATASET/ORTHOPHOTOS/light_directions.txt", "r") as f: 
...
# CUDA_VISIBLE_DEVICES=5 python train.py --port 8099 --image_size 96 --batchSize 16 --num_points 2500 --num_query 15000 --num_trees 700 --top_k 2500 --deciduous true --thres 25 --env mixed_colors --model 3 --top_k_shadows 2500 --shadow true --silhouettes true --model_previous_training true