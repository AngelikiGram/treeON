...
RADIUS = 0.15 # 0.07 # 0.0075 (for PRED -> 1) # 15
ply_folder = r'C:\Users\angie\Documents\treeON\results\landmarks\FRANCE'
ply_folder = r'C:\Users\angie\Documents\final\FRANCE\Ground_Truth_PointClouds'
output_folder = r'C:\Users\angie\Documents\final\FRANCE\GT_HR' # OURS_HR'
...
def render_and_save(output_path):
    bpy.context.scene.render.filepath = output_path.replace('output_', '')
...
def main():
    for fname in os.listdir(ply_folder):
        ...
        clear_scene()
        obj = import_ply_as_spheres(ply_path, sphere_radius=RADIUS)
        setup_camera(obj)
        add_sun_light(obj)
        obj.location.x -= 0.5
        # Save rendered image
